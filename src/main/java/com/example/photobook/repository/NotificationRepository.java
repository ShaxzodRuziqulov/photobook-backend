...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    @Query("""
            ...
            """)
    Page<Notification> findPageWithoutTextSearch(@Param("userId") UUID userId,
    ...
    @Query("""
            ...
            FROM Notification n
            WHERE n.user.id = :userId
              AND (LOWER(n.title) LIKE LOWER(CONCAT('%', :search, '%')) OR
            ...
            ORDER BY n.createdAt DESC
            """)
    Page<Notification> findPageWithTextSearch(@Param("userId") UUID userId,
